        ...
        <div class="container">
            <div class="columns ten alpha title-inner">
                <div style="margin-left:30px;">
                    ...
                    <p>{{ strip_tags(String::tidy(Str::limit($setting->services, 100)), '') }} </p>
                </div>
            </div>
            ...
            <div class="post-entry">
                ...
                <div class="post-info">
                    ...
                    <div class="post-categories">
                        <div style="margin-left:30px; margin-top:18px;"><small>发布时间:</small> <br/><a href="#">{{{ $business->created_at->format('Y-M-d') }}}</a></div>	</div>
                </div>
                <div class="post-body">
                    <p>
