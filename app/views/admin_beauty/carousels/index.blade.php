...
<div class="box box-primary">
    ...
    <ul class="todo-list ui-sortable">
      <table class="table table-hover">
        ...
        <tr>
          ...
          <th class="col-md-2">
            <a href="{{{ URL::to(sprintf('admin/carousels/%d/edit', $carousel->id)) }}}" class="iframe btn btn-xs btn-default"><i class="fa fa-edit"></i> {{{ Lang::get('button.edit') }}}</a>
            <a href="#deleteModal" data-target="#deleteModal" data-id="{{ $carousel->id }}" data-toggle="modal" class="iframe btn btn-xs btn-danger"><i class="fa fa-trash-o"></i> {{{ Lang::get('button.delete') }}}</a>
          </th>
        </tr>
        @endforeach
        </tbody></table>
  ...
  <div class="box-footer clearfix no-border">
    <a href="{{{ URL::to('admin/carousels/create') }}}" class="btn btn-default pull-right"><i class="fa fa-plus"></i><i class="icon-plus-sign"></i> {{{ Lang::get('button.create') }}}</a>
  </div>
</div>
